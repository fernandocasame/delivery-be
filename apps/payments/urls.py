...
from .views import DriverWalletDetailView, PolarWebhookView, CreatePolarCheckoutView, VerifyPolarPaymentView, PolarSuccessView, PolarCancelView
...
urlpatterns = [
    ...
    path('success/', PolarSuccessView.as_view(), name='polar_success'),
    path('cancel/', PolarCancelView.as_view(), name='polar_cancel'),
]
